namespace DisasterReport.Migrations
{
    ...
    public partial class Init : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        Type = c.Int(nullable: false),
                        FromReporter_Id = c.Guid(),
                        ToReporter_Id = c.Guid(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.DR_ReporterInfoTb", t => t.FromReporter_Id)
                .ForeignKey("dbo.DR_ReporterInfoTb", t => t.ToReporter_Id)
                .Index(t => t.FromReporter_Id)
                .Index(t => t.ToReporter_Id);
            ...
            CreateTable(
                "dbo.MessageGroupTbReporterInfoTbs",
                c => new
                    {
                        MessageGroupTb_Id = c.Guid(nullable: false),
                        ReporterInfoTb_Id = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => new { t.MessageGroupTb_Id, t.ReporterInfoTb_Id })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.DR_MessageNoteTb", "ToReporter_Id", "dbo.DR_ReporterInfoTb");
            ...
            DropIndex("dbo.DR_MessageNoteTb", new[] { "ToReporter_Id" });
