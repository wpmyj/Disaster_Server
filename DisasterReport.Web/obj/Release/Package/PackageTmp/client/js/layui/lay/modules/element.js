...
layui.define("jquery", function (i) {
    ...
    s.prototype.set = function (i) {
        ...
        //zxy start
        var a = this;
        var rtn = t.extend(!0, a.config, i);
        if(typeof rtn.tabDelCallback != 'undefined' && rtn.tabDelCallback && rtn.tabDelCallback instanceof Function) {
            deleteItemCallback = rtn.tabDelCallback;
        }
        return rtn, a;
        //zxy end
    };
    ...
    s.prototype.tabAdd = function (i, a) {
        ...
        return l.append("<li>" + (a.title || "unnaming") + "</li>"),
            n.append('<div class="layui-tab-item">' + (a.content || "") + "</div>"), y.tabAuto(), this
    };
    s.prototype.tabDelete = function (i, a, callback) {
        var e = t(".layui-tab[lay-filter=" + i + "]"),
    ...
    //zxy
    s.prototype.tabContentChange = function (i, a, content) {
        var e = t(".layui-tab[lay-filter=" + i + "]"),
            l = e.children(".layui-tab-title").find(">li").eq(a);
        return y.tabContentChange(null, a, l, content), this
    };
    //zxy
    var o = ".layui-nav",
        c = "layui-nav-item",
        ...
        y = {
            ...
            //zxy
            tabContentChange: function(i, a, s, content) {
                var o = s || t(this),
                    a = a || o.index(),
                    c = o.parents(".layui-tab"),
                    r = c.children(".layui-tab-content").children(".layui-tab-item"),
                    u = c.attr("lay-filter");
                    r.eq(a).html(content);    //zxy
                o.addClass(l).siblings().removeClass(l),
                    r.eq(a).addClass(n).siblings().removeClass(n),
                    layui.event.call(this, e, "tab(" + u + ")", {
                        elem: c,
            ...
            tabDelete: function (i, a) {
                ...
                e.hasClass(l) && (e.next()[0] ? y.tabClick.call(e.next()[0], null, n + 1) : e.prev()[0] && y.tabClick.call(e.prev()[0], null, n - 1)),
                    ...
                    o.eq(n).remove();
                    //zxy start
                    if(typeof deleteItemCallback != 'undefined' && deleteItemCallback && deleteItemCallback instanceof Function) {
            ...
            clickThis: function () {
                ...
                i.find("." + d)[0] || (a.find("." + l).removeClass(l),
                    i.addClass(l), layui.event.call(this, e, "nav(" + n + ")", i))
            },
            clickChild: function () {
                var i = t(this), a = i.parents(o),
                    n = a.attr("lay-filter"); a.find("." + l).removeClass(l),
                        i.addClass(l), layui.event.call(this, e, "nav(" + n + ")", i)
            },
            showChild: function () {
                var i = t(this),
            ...
            nav: function () {
                var i, e, l, s = 200,
                    p = function (o, c) {
                        var r = t(this),
                            y = r.find("." + d);
                        c.hasClass(u) ? o.css({ top: r.position().top, height: r.children("a").height(), opacity: 1 }) : (y.addClass(f), o.css({
                        ...
                        a.on("mouseleave", function () {
                            clearTimeout(i),
                                l = setTimeout(function () {
                                    a.hasClass(u) ? o.css({ height: 0, top: o.position().top + o.height() / 2, opacity: 0 }) : o.css({ width: 0, left: o.position().left + o.width() / 2, opacity: 0 })
                                }, s)
                        })),
                        f.each(function () {
                            var i = t(this),
